...
React.render(React.createElement(MainView, null), document.getElementById('winternote'));


},{"./views/MainView.jsx":175,"react/addons":3}],2:[function(require,module,exports){
...
module.exports = React.createClass({displayName: "exports",
  render: function () {
    return React.createElement("div", {className: "note-editor"}, "Winternote is WYSIWYG editor for semantic markup.");
  }
});
